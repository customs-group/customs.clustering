 ...
 */
public class Step1GroupComparator extends WritableComparator {
    //~ Constructors -----------------------------------------------------------

    public Step1GroupComparator() {
    ...
    public int compare(WritableComparable a, WritableComparable b) {
        Step1KeyWritable key1 = (Step1KeyWritable) a;
        Step1KeyWritable key2 = (Step1KeyWritable) b;
